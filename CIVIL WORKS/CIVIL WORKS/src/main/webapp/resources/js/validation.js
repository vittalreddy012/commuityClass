...
function uploadPDF(str, leaf)
{
    ...
    if ("pdf" != ext && "PDF" != ext && ext.length != 3)
    {
...
function isAlpha(keyCode, name)
{
    if (keyCode == 16)
        isShift = true;
    var str = document.forms[0].elements[name].value;
    // alert(str);
    if (str.substring(0, 1) == " ")
    {
        name.value = "";
        name.focus();
        return ((keyCode >= 65 && keyCode <= 90) || keyCode == 8 || keyCode == 9 || keyCode == 37 || keyCode == 39 || keyCode == 46 || (keyCode >= 96 && keyCode <= 105))
    } else {
        return ((keyCode >= 65 && keyCode <= 90) || keyCode == 8 || keyCode == 32 || keyCode == 9 || keyCode == 37 || keyCode == 39 || keyCode == 46 || (keyCode >= 96 && keyCode <= 105))
    }
}
